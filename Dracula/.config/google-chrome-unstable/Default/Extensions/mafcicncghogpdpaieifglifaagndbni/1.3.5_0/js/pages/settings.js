...
pages.settings = (async () => {
    ...
    const doSettings = async () => {
        ...
        let hasMoreNav = await get(`https://inventory.roblox.com/v1/users/${cachedUserId}/items/GamePass/67271922`)
        if (hasMoreNav) { hasMoreNav = hasMoreNav?.data?.[0] }
        ...
        const toggle = async () => {
            ...
            backButton.onclick = () => {window.location.href = "/my/account"}
                                            ...
                                            if (!item.sel) {
                                                if (key == "Navigation Buttons") {
                                                    if (item.type == "toggle") {
                                                        ...
                                                        let current = navigationSettings.custom[name] ?? {name: "", url: ""}
