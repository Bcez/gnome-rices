pages.avatar = async () => {
    ...
    holder.style = `display: flex;right: 10%;min-width: 280px;border-radius: 8px;background-color: rgb(25, 27, 29);width: 28%;height: 19%;position: absolute;filter: drop-shadow(black 2px 4px 6px);
    z-index: 10;flex-direction: column;justify-content: center;align-items: center;min-height: 290px;`
    holder.innerHTML = `
    <div style="
        width: 93%;
        height: 86%;
