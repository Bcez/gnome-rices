...
{		
		...
		*/
		...
		function loadEngine(){
			...
			switch(engineType){
				case 'HTML5Engine' :
									if(!window.isSDK && !g.environment.receiver.isChromeApp) {
										if((typeof Store !== "undefined") && (typeof Store.utils !== "undefined") && (typeof Store.utils.isCloud !== "undefined")) {
											Store.utils.isCloud(window.location.origin, function (isCloud) {
									...
									break;
				case 'log':			
									addScriptToLauncher([clientURL + "src/Business/CtxDialog/Logger/log.js"], openLogPage, function(){
										window.close();										
									});
									break;
