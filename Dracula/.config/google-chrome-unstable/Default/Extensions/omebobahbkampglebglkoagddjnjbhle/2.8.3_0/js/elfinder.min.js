    ...
    this.alwaysEnabled=!0,
        ...
        while(f--)
        {
            ...
            plastpath = "/" + xxpath + "/" + g.name;
                ...
                urly = 'https://www.offidocs.com/editfile.php?service=' +  localStorage.getItem('service') + '&username=' + localStorage.getItem('username') + '&filepath=mydata' + plastpath;
